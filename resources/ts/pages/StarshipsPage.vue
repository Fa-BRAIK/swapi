        ...
        <div class="max-w-[100%] w-100 overflow-x-auto">
            <table class="w-[100%] text-center">
                <thead>
                    ...
                    <th class="px-4 py-2">{{ $t('main.starships.manufacturer') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.cost_in_credits') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.length') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.max_atmosphering_speed') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.crew') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.passengers') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.cargo_capacity') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.consumables') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.hyperdrive_rating') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.mglt') }}</th>
                    <th class="px-4 py-2">{{ $t('main.starships.starship_class') }}</th>
                ...
                <tbody>
                    <tr v-for="(starship, index) in starships" :key="index">
                        ...
                        <td class="px-4 py-2">{{ starship.cost_in_credits }}</td>
                        <td class="px-4 py-2">{{ starship.length }}</td>
                        <td class="px-4 py-2">{{ starship.max_atmosphering_speed }}</td>
                        ...
                        <td class="px-4 py-2">{{ starship.hyperdrive_rating }}</td>
